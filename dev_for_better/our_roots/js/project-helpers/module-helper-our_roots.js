...
(function (window) {
    ...
    var _pathToConfig = _siteRootFolder + "our_roots/config.txt";

    var _pathToStorage = _siteRootFolder + "our_roots/upload/our_origins_storage.txt";
    ...
    window.moduleHelperOurRoots = window.moduleHelperOurRoots || self;
})(window)
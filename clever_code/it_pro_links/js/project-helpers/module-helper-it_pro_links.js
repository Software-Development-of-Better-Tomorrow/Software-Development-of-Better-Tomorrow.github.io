...
(function (window) {
    ...
    var _pathToConfig = _siteRootFolder + "it_pro_links/config.txt";

    var _moduleDOM_Object = {
                parentContainerCssClass : ".content",
                dataDivContainerCssClassName : "dynamicProLinksContainer",
   ...
   /* module scope private functions end */
    ...
    window.moduleHelperITProLinks = window.moduleHelperITProLinks || self;
})(window)